...
import { IntentAssessment, SmartDiff } from './brief.js';
...
/** Intent persisted for a PR (the IntentAssessment plus the pr_id it scopes). */
export const PrIntentRecord = IntentAssessment.extend({ pr_id: z.string() });
