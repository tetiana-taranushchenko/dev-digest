...
- Working inside a package → read that package's `CLAUDE.md`: [`server/CLAUDE.md`](server/CLAUDE.md), [`client/CLAUDE.md`](client/CLAUDE.md), [`reviewer-core/CLAUDE.md`](reviewer-core/CLAUDE.md), [`e2e/CLAUDE.md`](e2e/CLAUDE.md)
